...
const CACHE_POLICIES = {
  ...
  'hips-catalog-registry': {
    id: 'hips-catalog-registry',
    title: 'HiPS catalog registry',
    description: 'Progressive catalog HiPS discovered from the CDS MocServer.',
    mode: 'persistent-shared',
    strategy: 'network-first',
    ttl: daysToMs(1),
    allowStaleFallback: true,
...
const CACHE_INTEGRATIONS: CacheIntegrationDefinition[] = [
  ...
  {
    id: 'hips-catalog-registry',
    title: 'HiPS catalog discovery (MocServer)',
    modulePath: 'lib/services/hips/service.ts',
    policyId: 'hips-catalog-registry',
    owner: 'starmap-core',
    environments: ['web', 'tauri'],
    implementation: 'shared-policy',
  },
